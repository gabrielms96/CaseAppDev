...
namespace CaseAppDev.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCliente(int id,[FromForm]Clientes cliente)
        {
            if (id != cliente.ID)
            {
                return BadRequest();
        ...
        // more details see https://aka.ms/RazorPagesCRUD.
        [HttpPost]
        public async Task<ActionResult<Clientes>> PostCliente([FromForm]Clientes cliente)
        {
